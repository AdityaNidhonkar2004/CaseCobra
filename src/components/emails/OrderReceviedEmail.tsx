...
const OrderReceviedEmail = ({shippingAddress , orderId , orderDate}: {shippingAddress : ShippingAddress , orderId:string ,orderDate: string}) => {

    const baseUrl = process.env.NODE_ENV === "development" ? "http://localhost:3000" : "https://case-cobra-beryl.vercel.app"
  return (
    <Html>
        <Head />
                ...
                <Section style={paddingY}>
                    <Row>
                        <Text style={{...footer.text,paddingTop: 30 , paddingBottom: 30,}}>
                            Please contact us if tou have any questions.(If you have reply to this email, we won't be able to see it.)
                        </Text>
                    </Row>
                <Row>
...
export default OrderReceviedEmail
