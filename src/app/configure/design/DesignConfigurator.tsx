...
const DesignConfigurator = ({configId , imageUrl , imageDimensions}: DesignConfiguratorProps) => {
    ...
    onError: ()=>{
        toast({
            ...
            description: "There was en error on our end. Please try again",
            variant: "destructive",
        })},
    onSuccess: ()=>{
    ...
    const [renderedPoition,setRenderedPosition] = useState({
        x: 150,
        y: 205,
    })
    ...
    async function saveConfiguration() {
        ...
        try {
            ...
            const actualX = renderedPoition.x - leftOffset
            const actualY = renderedPoition.y - topOffset
            ...
            //Converting canvas to image to export it 
            const base64 =canvas.toDataURL()
            // console.log(base64);  its URL of image canvas
    ...
    <div className="relative mt-20 grid grid-cols-1 lg:grid-cols-3 mb-20 pb-20">
        <div
        ref={containerRef} 
        className=" relative h-[37.5rem] overflow-hidden col-span-2 w-full max-w-4xl flex items-center justify-center rounded-lg
         border-2 border-dashed border-gray-300 p-12 text-center focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2">
            ...
            <div className=" absolute z-40 inset-0 left-[3px] top-px right-[3px] bottom0px rounded-[32px] shadow-[0_0_0_99999px_rgba(229,231,235,0.6)] "/>
        ...
        <div className="h-[37.5rem] w-full col-span-full lg:col-span-1 flex flex-col bg-white">
                                ...
                                >
                                    ...
                                    <div className="mt-3 space-y-4">
                                        ...
                                        <RadioGroup.Option  key={option.value} value={option} className={({active,checked})=>
                                            cn(" relative block cursor-pointer rounded-lg bg-white px-6 py-4 shadow-sm border-2 border-zinc-200 focus:outline-none ring-0 sm:justify-between",{
            ...
            <div className="w-full px-9 h-16 bg-white">
